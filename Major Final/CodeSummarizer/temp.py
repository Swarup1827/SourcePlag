...
def ask_g4f(prompt):
    try:
        # Prepare and send request to g4f client
...
def copy_to_clipboard(message_label):
    ...
    root.update()
    messagebox.showinfo("Copied", "The response has been copied to the clipboard.")
...
def add_message_to_chat(sender, message, color, align):
    ...
    # Add a copy button for bot's responses
